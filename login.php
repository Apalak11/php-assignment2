<?php
  ...
  // Checking if the user is already logged in, if logged in then redirect user to welcome page
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username_err) && empty($password_err)) {
      ...
      $sql = 'SELECT id, username, password FROM myusers WHERE username = ?';
